...
export default function ReimbursementSetupView(): JSX.Element {
  ...
  return (
    <div className='flex flex-col items-center justify-center px-10 py-5'>
      ...
      <div className='mt-16'>You Z-Imburse Escrows</div>
      <button className='ml-auto mt-16' onClick={() => setShowGroupModal(true)}>
        + New Group
      </button>
      <div className='flex gap-16 justify-center mt-4 h-[360px] w-full'>
